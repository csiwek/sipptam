...
So if you want to refer to the `ip` and `port` of the tas running the `/tmp/test-0002_a.xml` scenario, we have to refer to it in the other scenarios as `!sipptas(host(1))!` and `!sipptas(port(1))!`.
